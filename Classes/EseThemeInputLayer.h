/**=============================================================================
	@file		EseThemeInputLayer.h
	@brief		画伯モード時のテーマ入力画面レイヤークラス 定義
...
#ifndef __ESE_THEME_INPUT_LAYER_H__
#define __ESE_THEME_INPUT_LAYER_H__
...
/**
	@class		EseThemeInputLayer
	@brief		GM代行なし時のテーマ入力レイヤークラス
*/
class EseThemeInputLayer : public SceneAtelierMain::ThemeInputLayer
{
	//=====================================================
	// 定数(列挙型)宣言
	//=====================================================
...
public:	
	...
	CREATE_FUNC(EseThemeInputLayer);
...
#endif	// __ESE_THEME_INPUT_LAYER_H__