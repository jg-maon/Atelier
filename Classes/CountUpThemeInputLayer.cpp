/**=============================================================================
	@file		CountUpThemeInputLayer.cpp
...
#pragma region CountUpThemeInputLayer methods

//---------------------------------------------------------------------------------------------------
// ボックス表示時に呼ばれる
void CountUpThemeInputLayer::editBoxEditingDidBegin(EditBox* editBox)
{
	log("editBox %p DidBegin !", editBox);
}
// OKボタン押したら呼ばれる
void CountUpThemeInputLayer::editBoxTextChanged(EditBox* editBox, const std::string& text)
{
...
// ボックス終了時に呼ばれる
void CountUpThemeInputLayer::editBoxEditingDidEnd(EditBox* editBox)
{
	log("editBox %p DidEnd !", editBox);
}

// ボックス終了後に呼ばれる
void CountUpThemeInputLayer::editBoxReturn(EditBox* editBox)
{
...
/**
	...
	@return		なし
*/
void CountUpThemeInputLayer::restart(const std::string& from)
{
	super::restart(from);
	//-----------------------------------------------------
	// EditBox有効化
...
/**
	...
	@retval		false	初期化失敗
*/
bool CountUpThemeInputLayer::_Init()
{
	...
	if (smallThemeBox)
	{
		...
		//if (titleLabel)
		{
			...
			titleLabel->setPosition(smallThemeBox->getPositionX(),
									smallThemeBox->getPositionY() + editBoxSize.height / 2.f + smallThemeBox->getContentSize().height / 2.f);
...
//												static_cast<unsigned int>(back->getContentSize().height));
		...
		//if (titleLabel)
		{
			...
			titleLabel->setPosition(kanaThemeBox->getPositionX(),
									kanaThemeBox->getPositionY() + editBoxSize.height / 2.f + kanaThemeBox->getContentSize().height / 2.f);
...
/**
	...
	@return		なし
*/
void CountUpThemeInputLayer::_SetErrorFlag(const std::string& editBoxName, bool flag)
{
...
/**
	...
	@return		なし
*/
void CountUpThemeInputLayer::_StartAnimation()
{
	// アニメーション中の動作拒否
...
#pragma endregion	// CountUpThemeInputLayer methods
