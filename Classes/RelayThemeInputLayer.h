/**=============================================================================
	@file		RelayThemeInputLayer.h
	@brief		お絵かきリレーモード時のテーマ入力画面レイヤークラス 定義
...
#ifndef __RELAY_INPUT_LAYER_H__
#define __RELAY_INPUT_LAYER_H__
...
/**
	@class		RelayThemeInputLayer
	@brief		GM代行なし時のテーマ入力レイヤークラス
*/
class RelayThemeInputLayer : public SceneAtelierMain::ThemeInputLayer
{
	//=====================================================
	// 定数(列挙型)宣言
	//=====================================================
...
public:	
	...
	CREATE_FUNC(RelayThemeInputLayer);
