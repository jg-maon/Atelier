/**=============================================================================
	@file		CountDownThemeInputLayer.h
...
#ifndef __COUNTDOWN_THEME_INPUT_LAYER_H__
#define __COUNTDOWN_THEME_INPUT_LAYER_H__
...
/**
	@class		CountDownThemeInputLayer
	@brief		GM代行なし時のテーマ入力レイヤークラス
*/
class CountDownThemeInputLayer : public SceneAtelierMain::ThemeInputLayer
{
	//=====================================================
	// 定数(列挙型)宣言
	//=====================================================
...
public:
	...
	CREATE_FUNC(CountDownThemeInputLayer);
...
#endif	// __COUNTDOWN_THEME_INPUT_LAYER_H__
